...
def get_consensus(test_excel):
    ...
    # We can access cultural consensus by using cultural assignment indexes
    # For example, culture "0" would be consensus[:,0], so forth.
    print(consensus[:,assigment_mode_culture])
    ...
    print('colorMap')
    print(colorMap)
    assigment_mode_culture = [str(s) for s in assigment_mode_culture]
    return [cultureMap, colorMap, assigment_mode_culture]